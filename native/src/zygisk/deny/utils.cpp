...
#if MAGISK_DEBUG
    LOGI("proc_monitor: [%s] PID=[%d] PPID=[%d] UID=[%d] is on the %s\n", cmdline, pid, ppid, uid, (sulist_enabled)? "sulist" : "hidelist");
#else
    LOGI("proc_monitor: [%s] PID=[%d] is on the %s\n", cmdline, pid, (sulist_enabled)? "sulist" : "hidelist");
#endif
